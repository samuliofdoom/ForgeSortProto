...
const ZERO_CONTAMINATION_BONUS: int = 25
...
func calculate_order_score(order: OrderDefinition) -> int:
	...
	if contamination_this_order == 0:
		base += ZERO_CONTAMINATION_BONUS
